...
{
    public partial class Addfdsfds : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cate_Alias = table.Column<string>(nullable: true),
                    Cate_Description = table.Column<string>(nullable: true),
                    Cate_Image = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Class_Description = table.Column<string>(nullable: true),
                    StartTime = table.Column<DateTime>(nullable: false),
                    EndTime = table.Column<DateTime>(nullable: false),
                    Class_Address = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpenRegisters_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingCourses_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OptionClasses", x => new { x.Class_Id, x.OptionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedBy = table.Column<string>(nullable: true),
                    Status = table.Column<int>(nullable: false),
                    Stu_Code = table.Column<string>(nullable: true),
                    Stu_Fullname = table.Column<string>(nullable: true),
                    Stu_Gender = table.Column<string>(nullable: true),
                    DateOfBirth = table.Column<DateTime>(nullable: false),
                    Stu_Phone = table.Column<string>(nullable: true),
                    Stu_Email = table.Column<string>(nullable: true),
                    Stu_Facebook = table.Column<string>(nullable: true),
                    Identity_Card = table.Column<string>(nullable: true),
                    ClassId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "OpenRegisterUsers",
                columns: table => new
                {
                    OpenId = table.Column<int>(nullable: false),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpenRegisterUsers", x => new { x.UserId, x.OpenId });
                    table.ForeignKey(
                        name: "FK_OpenRegisterUsers_OpenRegisters_OpenId",
                        column: x => x.OpenId,
                        principalTable: "OpenRegisters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OpenRegisterUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingCourses_ClassId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpenRegisters_CourseId",
                table: "OpenRegisters",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_OpenRegisterUsers_OpenId",
