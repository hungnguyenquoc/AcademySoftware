...
import { AdminCourseCategoryComponent } from './views/admin-course-category/admin-course-category.component';
import { CourseCategoryListResolver } from './_resolvers/course-Category-List.resolver';
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: AdminCourseCategoryComponent,
